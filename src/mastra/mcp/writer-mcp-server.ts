...
1. start_article_workflow with notes (operating instructions) and optional authorDraft (prose to develop) — waits until a draft is ready for human review (can take several minutes).
2. get_article_drafts / get_article_status to inspect progress.
3. approve_draft or reject_draft (with guidance notes) to continue the article loop.
